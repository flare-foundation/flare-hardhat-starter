...
contract MyLzApp is NonblockingLzApp {
     ...
     *
     * @dev Calls the LayerZero V1 endpoint to calculate the native and ZRO token fees
     ...
     * @param _adapterParams Encoded gas limit and additional parameters for the LayerZero

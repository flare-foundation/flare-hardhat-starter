...
/// @notice **This contract is an EndpointV1 OFT implementation** and should not be used
///         for new OFT deployments.
/// @dev The name `OFTV2` refers to the V2 implementation of the OFT on LayerZero EndpointV1
///      and not LayerZero EndpointV2.
...
contract MyEndpointV1OFTV2 is OFTV2 {
    ...
    /// @param _sharedDecimals The number of shared decimals for cross-chain
    ///         transfers.

 ...
 *
 * Usage:
 * yarn hardhat run scripts/fassets/bridgeToSepolia.ts --network coston2
 */
...
const CONFIG = {
    ...
    COSTON2_COMPOSER: process.env.COSTON2_COMPOSER || "0x285eed88D408F59c03Cb0e9c169d5F84a66775dc",

...
async function main() {  
  ...
  const FAssetsRedemptionQueueReader = await ethers.getContractFactory("FAssetsRedemptionQueueReader") as FAssetsRedemptionQueueReaderContract;

  // Deploy the contract
  const fAssetsRedemptionQueueReader = await FAssetsRedemptionQueueReader.deploy(ASSET_MANAGER_ADDRESS) as FAssetsRedemptionQueueReaderInstance;
